...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="site-info container">
			...
			<span class="sep"> | </span>
			<?php printf( __( 'Theme: %2$s by %1$s', 'moesia' ), 'aThemes', '<a href="http://athemes.com/theme/moesia">Moesia</a>' ); ?><br>
			<span class="developer">Website by <a href="http://acodeabove.com">A Code Above</a></span>
		</div><!-- .site-info -->
